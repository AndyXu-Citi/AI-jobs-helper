# v3.0 跑通的第二天，我发现它只有我自己能用 —— AI-jobs-helper v3.1 把求职 Agent 接进 MCP 生态的两个晚上

> 项目：AI-jobs-helper v3.1（在 v3.0 LangGraph Agent 基础上加 MCP Server + Bad Case 闭环）
...
- **Agent 这个标签市场上 106 条**——这就是为什么我要把项目名从「AI-jobs-helper」改叫「求职 Agent」
...
>
> 代码：[github.com/AndyXu-Citi/AI-jobs-helper](https://github.com/AndyXu-Citi/AI-jobs-helper)
...
Repo: [github.com/AndyXu-Citi/AI-jobs-helper](https://github.com/AndyXu-Citi/AI-jobs-helper)
